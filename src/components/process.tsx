                ...
                <AnimatedDiv animationClass="animate-scale-in" delay={600}>
                    <Card className="text-center max-w-4xl mx-auto p-8 md:p-12 rounded-3xl shadow-lg relative overflow-hidden">
                        <CardContent className="p-0 relative z-10">
                            ...
                            <Button asChild size="lg" className="rounded-full h-14 px-8 text-base bg-gradient-to-r from-primary to-primary-light text-white font-medium shadow-lg transition-transform hover:scale-105">
