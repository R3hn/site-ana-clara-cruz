 ...
 *
 * - melasmaPhotoAnalysis - A function that handles the photo analysis process.
 * - MelasmaPhotoAnalysisInput - The input type for the melasmaPhotoAnalysis function.
 * - MelasmaPhotoAnalysisOutput - The return type for the melasmaPhotoAnalysis function.
 */
...
const MelasmaPhotoAnalysisInputSchema = z.object({
  photoDataUri: z
    .string()
    .describe(
...
export type MelasmaPhotoAnalysisInput = z.infer<typeof MelasmaPhotoAnalysisInputSchema>;

const MelasmaPhotoAnalysisOutputSchema = z.object({
  melasmaDetected: z
    .boolean()
...
export type MelasmaPhotoAnalysisOutput = z.infer<typeof MelasmaPhotoAnalysisOutputSchema>;

export async function melasmaPhotoAnalysis(
  input: MelasmaPhotoAnalysisInput
): Promise<MelasmaPhotoAnalysisOutput> {
  return melasmaPhotoAnalysisFlow(input);
}

const prompt = ai.definePrompt({
  name: 'melasmaPhotoAnalysisPrompt',
  input: {schema: MelasmaPhotoAnalysisInputSchema},
  output: {schema: MelasmaPhotoAnalysisOutputSchema},
...
const melasmaPhotoAnalysisFlow = ai.defineFlow(
  {
    name: 'melasmaPhotoAnalysisFlow',
    inputSchema: MelasmaPhotoAnalysisInputSchema,
    outputSchema: MelasmaPhotoAnalysisOutputSchema,
  },
  async input => {
